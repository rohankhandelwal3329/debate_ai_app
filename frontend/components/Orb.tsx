...
export interface OrbProps {
  ...
  /** When false (default), pointer events are ignored — drive visuals only via props. */
  interactive?: boolean;
}
...
export default function Orb({
  ...
  }, [hue, hoverIntensity, rotateOnHover, forceHoverState, backgroundColor, interactive]);
